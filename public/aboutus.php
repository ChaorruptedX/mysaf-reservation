...
<div class="row">
  <div class="column">
    <div class="card">
      <img class ="alias" src="assets/image/zaki.jpg" alt="zaki" style="width:100%">
      <div class="container">
        <h2>Ameerul Zaki Bin Azlan Raous</h2>
  ...
  <div class="column">
    <div class="card">
      <img class  src="assets/image/acap.jpg" alt="acap" style="width:100%">
      <div class="container">
        <h2>Mohd Asyraf Bin Mohamed Hanif</h2>
  ...
  <div class="column">
    <div class="card">
      <img class ="alias" src="assets/image/abu.jpg" alt="abu" style="width:100%">
      <div class="container">
        <h2>Abu Dzar Bin Adam</h2>
