<nav class="sidenav">
    ...
    <a class="<?= active_url(["user-management.php", "register-user.php","update-user.php"]); ?>" href="<?= constant("BASEURL") . 'public/committee/user-management.php' ?>">User Management</a>
    ...
    <a class="<?= active_url(["list_reservation.php","view-reservation-list.php", "update-reservation.php"]); ?>" href="<?= constant("BASEURL") . 'public/committee/list_reservation.php' ?>">List Reservation</a>
